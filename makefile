...
$(PROGRAM_NAME)$(EXEEXT): main.o funcs.o Point2D.o Vec3D.o Point3D.o Face3D.o Colour.o Material.o BoundingSphere.o Mesh.o obstacle.o powerup.o HUD.o Player.o TrackingCamera.o Camera.o
